...
import { resolveTheme, resolveVerifiedOverride, sanitizeUsername, sanitizePhotoUrl, generateDefaultAvatar } from '@/utils/theme';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const customPhoto = sanitizePhotoUrl(searchParams.get('photo'));
    const image = customPhoto || result.image || generateDefaultAvatar(sanitized, isDark);
