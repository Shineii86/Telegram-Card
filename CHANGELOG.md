...
### Changed
- **README overhaul**: Trimmed from ~63KB to ~12KB — moved detailed guides into `docs/` folder
- **New docs structure**: `docs/ARCHITECTURE.md`, `docs/THEMING.md`, `docs/INTEGRATION.md`, `docs/DEPLOYMENT.md`, `docs/FAQ.md`
- **README focus**: Hero, showcase, quick start, API reference, features summary, and links to full documentation
